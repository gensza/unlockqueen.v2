	...
	<div class="col-md-12">
		...
		<div class="portlet">
			...
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-cogs"></i>Server Services
				</div>
			</div>
			<div class="portlet-body">
				...
				<a href="<?php echo site_url('admin/serverservice/add') ?>"><button id="sample_editable_1_new" class="btn btn-success">Add Server Service <i class="fa fa-plus"></i></button></a>
			</div>
		</div>
...
<?php }	?>	
    $('#TableDeferLoading').DataTable( {
		...
		"serverSide": true,
		"deferRender": true,
		"ajax": "<?php echo site_url('admin/serverservice/listener'); ?>",
		"order": [[ 0, 'asc' ]],
        "columnDefs": [
